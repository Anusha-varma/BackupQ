...
const TrafficSimulator = () => {
  ...
  const simulateGradualIncrease = () => {
    ...
    const interval = setInterval(() => {
      ...
      // Simulate traffic spike with smaller increments
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between mb-2">
                        ...
                        <span className="text-sm font-medium">{customUserCount} users</span>
                      </div>
                      <Slider
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <span className="ml-2 font-medium">{userCount}</span>
                        </div>
                        <div>
